...
## All I really wanted to do was use dplyr in a function that made interaction plots with `ggplot`. 

Easy, right? Yeah, once I knew how to do it. 
...
```{r}
interaction_plot2(dat, year, hours)
```
...
```{r}
interaction_plot_final(dat, year, hours)
```
